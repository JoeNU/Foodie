...
// This is an interface. We may use different data bases later. Since they
// have common abilities, so we define an interface, then we use different 
// classes to implement it for different data bases.
...
public interface DBConnection {
	...
	/**
	 * Verify if the userId matches the password. (This will be covered in security topic.)
	 * 
	 * @param userId
	 * @param password
	 * @return
